<div>
    <button type="button" class="{{$id? 'btn-warning' : 'btn-primary'}}" data-toggle="modal" data-target="#formUser{{ $id ?? ''}}">
        @if ($id)
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group my-1">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{$id ? $name : old ('namee')}}">
              </div>
            </div>
